...
- Vehicle aim points now use the vehicle model centre with a 2.5-metre downward correction to prevent drones from passing above vehicle roofs.
...
- Added a dedicated impact-point prediction function for direct and predictive attacks.
- Maximum attack speed now consistently derives from the existing Drone Flight Speed setting.
- Improved terminal steering against rapidly moving vehicles.
- Preserved line-of-sight checks, terrain checks, obstruction recovery, player takeover handling, and target reacquisition.
...
| Vehicle aim-height correction | -2.5 m |
