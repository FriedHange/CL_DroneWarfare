...
if (isClass (configFile >> "CfgVehicles" >> "B_Crocus_AP_Bag") || {isClass (configFile >> "CfgVehicles" >> "B_Crocus_AP_F")}) then {
    [
        "CLDW_Mod_Crocus",
        "CHECKBOX",
...
if (isClass (configFile >> "CfgVehicles" >> "B_KVN_AP_Bag") || {isClass (configFile >> "CfgVehicles" >> "B_KVN_AP_F")}) then {
    [
        "CLDW_Mod_KVN",
        "CHECKBOX",
...
if (isClass (configFile >> "CfgVehicles" >> "B_UAFPV_IED_AP_Bag") || {isClass (configFile >> "CfgVehicles" >> "B_UAFPV_IED_AP")}) then {
    [
        "CLDW_Mod_UAFPV_Tom",
        "CHECKBOX",
